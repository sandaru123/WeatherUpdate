...
using WeatherUpdate.Service;
using WeatherUpdate.Service.Interface;

namespace WeatherUpdate.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHostedService<BackgroundWeatherUpdate>();

            // services.AddDbContext<WeatherDbContext>();
            string conStr = this.Configuration.GetConnectionString("DefaultConnection");
            services.AddDbContext<WeatherDbContext>(options => options.UseSqlServer(conStr));
